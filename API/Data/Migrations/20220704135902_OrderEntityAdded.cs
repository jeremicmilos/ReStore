        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ItemOrder_ProductId = table.Column<int>(type: "INTEGER", nullable: true),
                    ItemOrder_Name = table.Column<string>(type: "TEXT", nullable: true),
                    ItemOrder_PictureUrl = table.Column<string>(type: "TEXT", nullable: true),
                    Price = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "161e95db-8459-443f-b7bc-75491b244035", "Member", "MEMBER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, "53180db4-ab70-4c01-9dfc-711b318787b8", "Admin", "ADMIN" });
